 ...
 */
  ...
  void MySolver<dim>::output_guess ()
  {
    ...
    VectorTools::interpolate (dof_handler, Potential_fct, m_Psi_ref );    
    constraints.distribute(m_Psi_ref);
  ...
  */
  ...
  void MySolver<dim>::run2b ()
  {
    ...
    pcout << "T - mu N " << T-m_mu*N << endl;
    pcout << "gs*W + V2 " << m_gs[0]*W + V2 << endl;
