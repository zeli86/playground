...
namespace MyRealTools
{
  ...
  template double Particle_Number<2>(const DoFHandler<2>&, const FE_Q<2>&, const Vector<double>&);
  template double Particle_Number<3>(const DoFHandler<3>&, const FE_Q<3>&, const Vector<double>&);
...
namespace MyRealTools
{
  namespace MPI
  {
    ...
    template<int dim>
    double Particle_Number(MPI_Comm mpi_communicator, const DoFHandler<dim>& dof_handler, const FE_Q<dim>& fe, const LA::MPI::Vector& vec)
    {
    ...
    template double Particle_Number<2>(MPI_Comm, const DoFHandler<2>&, const FE_Q<2>&, const LA::MPI::Vector&);
    template double Particle_Number<3>(MPI_Comm, const DoFHandler<3>&, const FE_Q<3>&, const LA::MPI::Vector&);
    ...
    template void AssembleSystem_Jacobian<2>(const DoFHandler<2>&, const FE_Q<2>& fe, const  AffineConstraints<double>&, const LA::MPI::Vector&, const Function<2>&, const double, const double, LA::MPI::SparseMatrix&);
    template void AssembleSystem_Jacobian<3>(const DoFHandler<3>&, const FE_Q<3>& fe, const  AffineConstraints<double>&, const LA::MPI::Vector&, const Function<3>&, const double, const double, LA::MPI::SparseMatrix&);
    ...
    template void AssembleRHS_L2gradient<2>(const DoFHandler<2>&, const FE_Q<2>& fe, const AffineConstraints<double>&, const LA::MPI::Vector&, const Function<2>&, const double, const double, double& res, LA::MPI::Vector&);
    template void AssembleRHS_L2gradient<3>(const DoFHandler<3>&, const FE_Q<3>& fe, const AffineConstraints<double>&, const LA::MPI::Vector&, const Function<3>&, const double, const double, double& res, LA::MPI::Vector&);
    ...
    template <int dim>
    void Compute_E_lin(MPI_Comm mpi_communicator,
                       const DoFHandler<dim>& dof_handler,
                       const FE_Q<dim>& fe,
                       const AffineConstraints<double>& constraints,
                       const Function<dim>& Potential,
                       const LA::MPI::Vector& vec,
                       double& T, double& N, double& W)
    {
    ...
    template void Compute_E_lin<2>(MPI_Comm, const DoFHandler<2>&, const FE_Q<2>&, const AffineConstraints<double>&, const Function<2>&, const LA::MPI::Vector&, double&, double&, double&);
    template void Compute_E_lin<3>(MPI_Comm, const DoFHandler<3>&, const FE_Q<3>&, const AffineConstraints<double>&, const Function<3>&, const LA::MPI::Vector&, double&, double&, double&);
  }
}
