...
def window(LT, title):
    ...
    #RenderView1.CameraFocalPoint = [0, 0, 0.0] # for TRAP
    #RenderView1.CameraPosition = [0, 0, -70] # for TRAP
    RenderView1.CameraFocalPoint = [15, 0, 0] # for GOST
    RenderView1.CameraPosition = [15, 0, -70] # for GOST
